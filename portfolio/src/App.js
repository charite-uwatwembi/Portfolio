...
function App() {
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-black text-white">
      ...
      <div className="flex justify-between items-stretch w-4/5 mb-10 mt-10">
      <header className="bg-black p-5 pt-10 pb-0 rounded-3xl shadow-md border border-gray-600 flex-grow mr-5">
  <div className="flex flex-col space-y-6">
    <div className="flex place-items-center justify-between">
      ...
      <div className="flex space-x-4 ml-5 items-center mt-5">
        ...
        <button className="bg-black text-white px-4 rounded-xl font-medium border border-gray-600 py-2 shadow">Get In Touch</button>
      </div>
    </div>

    <h2 className="text-4xl m-0 font-semibold">Obsessed with creating <em className="font-thin">timeless</em> digital products experiences for <em className="font-thin ">You-sers</em></h2>
    <p className="text-lg ">Hey 👋, I'm Charite, welcome to my world. I love building beautiful, timeless web apps & digital products experiences for users</p>
        ...
        <div className="bg-black  rounded-3xl shadow-md border border-gray-600 flex-none w-1/3 flex justify-center items-center">
